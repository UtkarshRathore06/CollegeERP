...
from information.models import Dept, Class, Student, Attendance, Course, Teacher, Assign, AssignTime, AttendanceClass
from information.models import StudentCourse, Marks, User, AttendanceRange
